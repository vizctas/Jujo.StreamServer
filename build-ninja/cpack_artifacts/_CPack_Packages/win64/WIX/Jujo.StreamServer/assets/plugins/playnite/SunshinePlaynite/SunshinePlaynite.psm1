<#
  Jujo.Stream Playnite Connector (PowerShell Script Extension)
  - Connects to Jujo.Stream Server over named pipes (control + data via anonymous handshake)
...
function Initialize-Logging {
  try {
    ...
    $hdr = @(
      "[$ts] === Jujo.Stream Playnite Connector starting ===",
