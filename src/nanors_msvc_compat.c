// MSVC-compatible copy of third-party/nanors/rs.c.
// The upstream implementation uses C99 variable-length arrays in decode(),
// which MSVC C does not support. Keep this file limited to that portability fix.
